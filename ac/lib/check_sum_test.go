...
func TestCRC(t *testing.T) {
	data := []byte {
		0x68, 0x01, 0x00, 0x80, 0x18, 0x02, 0x01, 0x00, 0x1e, 0x00, 0x83, 0x75, 0x41, 0x57, 0xf8, 0xf0, 0x09, 0x59, 0xef, 0x8f, 0x0e, 0xe9, 0xfc, 0xbb, 0x29, 0x09, 0x7b, 0xf5,0x5f, 0xac, 0x1d , 0x21, 0x46,
	}
	fmt.Printf("%x",CheckSum(data))
}
